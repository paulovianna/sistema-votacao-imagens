...
(function (factory) {
    ...
    $.extend($.fn.modal.Constructor.prototype, {
		...
		getCategoria: function (element) {
			return $(element).data('categoria');
		},
        ...
        loadImage: function () {
            var $this = this,
				...
				categoria = this.getCategoria(this.$links[index]),
				id = this.getId(this.$links[index]),
                oldImg;
            this.abortLoad();
            this.stopSlideShow();
        ...
        $(document.body).on(
            ...
            function (e) {
                ...
                if (link.length && modal.length) {
					...
					options.id = link.data('id');
					options.categoria = link.data('categoria');
